  ...
  return (
    <>
      ...
      <header className="app-header">
        ...
        {/* === JSX UNTUK SWITCH BARU === */}
        <div className="toggle-switch">
          <button
            /* - Tombol 'C' mendapat kelas 'active' jika unit = metric
              - onClick hanya berfungsi jika unit BUKAN metric
              - Tombol di-disable jika unit = metric
            */
          ...
          <button
            /* - Tombol 'F' mendapat kelas 'active' jika unit = imperial
              - onClick hanya berfungsi jika unit BUKAN imperial
              - Tombol di-disable jika unit = imperial
            */
